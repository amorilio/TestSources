// StructSerialization.cpp : Defines the entry point for the console application.
//

#include "stdafx.h"

// C++ Program to convert a 'struct' in 'hex string' and vice versa
#include <iostream>
#include <iomanip>
#include <sstream>
#include <string>
...
void convert_to_struct(istream& ip, unsigned char* data, int size)
{
	...
	// Read in unsigned ints, as wrote out hex version of ascii code
	unsigned int u = 0;
	int i = 0;
...
int main()
{
	...
	convert_to_hex_string(op, reinterpret_cast<const unsigned char*>(&student1), sizeof(Student_data));
	...
	convert_to_struct(ip, reinterpret_cast<unsigned char*>(&student2), sizeof(Student_data));
